  ...
  <div id="order-page">
      ...
      <div class="product-container diff-shadow">
        <div class="box1">
          <div class="form-container">
            ...
            <div class="ap-e">
              <button class="btn btn-orange ap" @click="clearProduct">
                Clear Product
              </button>
            </div>
      ...
      <div class="diff-shadow">
        <div id="payment-selection" class="payment-method-container">
          <div class="flex-box mr-2">
            ...
            <label class="custom-radio" style="margin-right: 10px"
              >Cash
              <input
                type="radio"
                name="payment_method"
        ...
        <div class="payment-container">
            ...
            <div class="form-container">
              ...
              <template v-if="paymentMethod === 'credit'">
                ...
                <div class="bt-i">
                  ...
                  />
                  <span v-if="validateRegularCustomer" class="form-error">{{
          ...
          <div id="pay-box2">
            ...
            <button class="btn btn-orange" @click="cancelModal = true">
              Cancel Order
            </button>
          </div>
        </div>
    ...
    <Modal v-if="addCustModal">
      ...
      <template v-slot:body>
        ...
        <ErrorField
          v-if="authFieldErrors.username"
          :errorField="authFieldErrors.username"
        ></ErrorField>
      </template>
...
export default defineComponent({
  ...
  created: async function () {
    ...
    this.walkinCustomer = this.customers.find(
      (item: User) => item.username && item.username === "WALK_IN_CUSTOMER"
    );
  ...
  computed: {
    ...
    selectedBatchQuantity: function (): number {
      ...
      if (
        ...
        const selectedBatchQuantityStr =
  ...
  methods: {
    ...
    selectProduct: async function (productId: number, VariantId: number) {
      ...
      this.productBatchSelect = currentVariant.batch
        .filter(
          (batch: Batch) => batch.quantity && parseFloat(batch.quantity) > 0
        )
        // eslint-disable-next-line
    ...
    changeQuantity: function (index: number) {
      ...
      if (currentVariant !== undefined) {
        ...
        if (
          ...
          const upperLimit = currentBatch.quantity
            ? parseFloat(currentBatch.quantity)
            : 0;
